      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed">
            Delivering fresh, delicious meals right to your doorstep. Taste the
            love in every bite 🍴
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-3 text-gray-700">
            {[
              { titel: "Home", link: "/" },
              { titel: "Menu", link: "/menu" },
              { titel: "Contact", link: "/contact" },
              { titel: "About", link: "/about" },
              { titel: "Blog", link: "/" },
              { titel: "Privacy", link: "/privacy" },
              { titel: "Terms", link: "/terms" },
            ].map((item, index) => (
              <li key={index}>
                <Link
                  to={item.link}
        ...
        >
          ...
          <p className="text-gray-600 mb-3">
            Get weekly food tips and hot offers delivered to your inbox!
          </p>
          <div className="flex flex-col space-y-3">
            ...
            <motion.button
              ...
              onClick={() =>
                (window.location.href = `mailto:firozkhan192006@gmail.com ${encodeURIComponent(
                  "Subject: FoodieHub Newsletter"
                )}`)
              }
