...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen mt-10 bg-white text-gray-800 px-4 py-12">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white p-8 rounded-t-3xl text-center">
            <h2 className="text-4xl font-bold">Checkout</h2>
            <p className="mt-2 text-sm opacity-80">Review and complete your order</p>
          </div>
          ...
          <div className="p-6 md:p-10 space-y-10">
            ...
            <motion.div
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{user?.email || "No Email"}</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4 max-h-[400px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-blue-300/60">
                {cart.map((item) => (
                  <div key={item._id} className="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-4 shadow-sm hover:shadow-md transition">
                    <img
